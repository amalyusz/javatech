...
public class Windows extends Frame{
		...
		public Windows()
		{
			...
			t_uzenet = new TextField("Állítsa be az adatokat, majd kattintson a Start gombra!",50);
			...
			b_tipp.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent c){		
					...
					{					
						...
						boolean wrong = false;
						// Megnézzük, hogy a két érték nem nagyobb-e, mint amekkore a pálya alapján lehet
		...
		public void resultOnMyBoard(Coordinate tipp)
		{
			...
			if (s_tipp.toLowerCase().equals("score"))
			{
				if(cb_server.isSelected())
				{
					t_uzenet.setText("Kliens tippje: "+tipp_x+" "+tipp_y+". Eredménye: Találat! Írja be a tippjét!");
				}
				else
					t_uzenet.setText("Szerver tippje: "+tipp_x+" "+tipp_y+". Eredménye: Találat! Írja be a tippjét!");
			...
			else
			{
				if(cb_server.isSelected())
				{
					t_uzenet.setText("Kliens tippje: "+tipp_x+" "+tipp_y+". Eredménye: Nem talált! Írja be a tippjét!");
				}
				else
					t_uzenet.setText("Szerver tippje: "+tipp_x+" "+tipp_y+". Eredménye: Nem talált! Írja be a tippjét!");
			}
		...
		public void resultOnEnemyBoard(int i_tippx, int i_tippy)
		{
			...
			else //cb_single.isSelected()
			{
				...
				// !!!
				// Shoot fv-ek visszatérési értéke használható legyen! kell, hogy mi a tipp eredménye!!!
				...
				t_uzenet.setText("Játékos eredménye: "+s_res_me+". Gép eredménye: "+s_res_comp);
		...
		// a kliens a szervertõl kapott pályaméret alapján építi fel a sajátját
